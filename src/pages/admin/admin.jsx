...
export const Admin = () => {
    ...
    // const [tableName, setTableName] = useState("producto");
    function handlePageChange( newPage, newTableName ) {
        setPage(newPage);
        ...
        <div className="absolute top-0 flex items-center justify-between w-full h-[70px] bg-[#FBFCFF] border-b-1 border-[#b0b0b0] px-[50px]">
            <div className="flex items-center w-full space-x-20">
                ...
                <section className="flex w-full items-center">
                    <div className="flex items-center justify-center w-full h-[70px] hover:bg-[#F0F0F0]">
                        <Button onClick={()=>{handlePageChange( 'Inicio')}} className="text-gray-600 hover:text-[#7BA8FF] w-full h-[70px] shadow-none">Inicio</Button>
                    </div>
                    <div className="flex items-center justify-center w-full h-[70px] hover:bg-[#F0F0F0]">
                        <Button onClick={()=>{handlePageChange( 'Clientes')}} className="text-gray-600 hover:text-[#7BA8FF] w-full h-[70px] shadow-none">Clientes</Button>
                    </div>
                    <div className="flex items-center justify-center w-full h-[70px] hover:bg-[#F0F0F0]">
                        <Button onClick={()=>{handlePageChange( 'Productos')}} className="text-gray-600 hover:text-[#7BA8FF] w-full h-[70px] shadow-none">Productos</Button>
                    </div>
                    <div className="flex items-center justify-center w-full h-[70px] hover:bg-[#F0F0F0]">
                        <Button onClick={()=>{handlePageChange( 'Proveedores' )}} className="text-gray-600 hover:text-[#7BA8FF] w-full h-[70px] shadow-none">Proveedores</Button>
                    </div>
                    <div className="flex items-center justify-center w-full h-[70px] hover:bg-[#F0F0F0]">
